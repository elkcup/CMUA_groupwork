...
def frechet_classifier_distance_from_activations(real_activations,
    ...
    real img_align_celeba and generated img_align_celeba. This can be used independently of the
    ...
    which captures how different the distributions of real img_align_celeba and generated
    img_align_celeba (or more accurately, their visual features) are. Note that unlike the
    Inception score, this is a true distance and utilizes information about real
    world img_align_celeba.
...
def kernel_classifier_distance_and_std_from_activations(real_activations,
    ...
    compute multiple metrics based on the same img_align_celeba. It also returns a rough
    ...
    This captures how different the distributions of real and generated img_align_celeba'
    visual features are. Like the Frechet distance (and unlike the Inception
    score), this is a true distance and incorporates information about the
    target img_align_celeba. Unlike the Frechet score, this function computes an
...
def get_fid(fcd, batch_size, images1, images2, inception_images, real_activation, fake_activation, activations):
    # print('Calculating FID with %i img_align_celeba from each distribution' % (images1.shape[0]))
...
def get_kid(kcd, batch_size, images1, images2, inception_images, real_activation, fake_activation, activations):
    # print('Calculating KID with %i img_align_celeba from each distribution' % (images1.shape[0]))
    start_time = time.time()
    act1 = get_inception_activations(batch_size, images1, inception_images, activations)
    act2 = get_inception_activations(batch_size, images2, inception_images, activations)
