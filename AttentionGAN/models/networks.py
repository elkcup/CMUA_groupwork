...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    Parameters:
        input_nc (int) -- the number of channels in input img_align_celeba
        output_nc (int) -- the number of channels in output img_align_celeba
    ...
    Our current implementation provides two types of generators:
        U-Net: [unet_128] (for 128x128 input img_align_celeba) and [unet_256] (for 256x256 input img_align_celeba)
...
def define_D(input_nc, ndf, netD, n_layers_D=3, norm='batch', init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    Our current implementation provides three types of discriminators:
        ...
        than a full-image discriminator and can work on arbitrarily-sized img_align_celeba
...
class GANLoss(nn.Module):
    ...
    def get_target_tensor(self, prediction, target_is_real):
        ...
        Parameters:
            ...
            target_is_real (bool) - - if the ground truth label is for real img_align_celeba or fake img_align_celeba
...
def cal_gradient_penalty(netD, real_data, fake_data, device, type='mixed', constant=1.0, lambda_gp=10.0):
    ...
    Arguments:
        ...
        real_data (tensor array)    -- real img_align_celeba
        fake_data (tensor array)    -- generated img_align_celeba from the generator
    ...
    """
    if lambda_gp > 0.0:
        if type == 'real':   # either use real img_align_celeba, fake img_align_celeba, or a linear interpolation of two.
...
class UnetSkipConnectionBlock(nn.Module):
    ...
    def __init__(self, outer_nc, inner_nc, input_nc=None,
        ...
        Parameters:
            ...
            input_nc (int) -- the number of channels in input img_align_celeba/features
