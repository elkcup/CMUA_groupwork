...
import auto_pgd_attacks as attacks
...
def parse(args=None):
    with open(join('./auto_pgd_setting.json'), 'r') as f:
...
os.system('cp ./auto_pgd_setting.json {}'.format(os.path.join(args_attack.global_settings.results_path, 'results{}/auto_pgd_setting.json'.format(args_attack.attacks.momentum))))
