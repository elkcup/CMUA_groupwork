...
# This architecture is for img_align_celeba of 128x128
...
class AttGAN():
    def __init__(self, args):
        ...
        self.device_str = 'cuda' if torch.cuda.is_available() and self.gpu else 'cpu'
        self.G.train()
        ...
        summary(self.D, [(3, args.img_size, args.img_size)], batch_size=4, device=self.device_str)
        ## 增加兼容
