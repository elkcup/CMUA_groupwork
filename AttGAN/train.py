...
def parse(args=None):
    ...
    parser.add_argument('--n_samples', dest='n_samples', type=int, default=16, help='# of sample img_align_celeba')
...
print('Training img_align_celeba:', len(train_dataset), '/', 'Validating img_align_celeba:', len(valid_dataset))
