...
def __write_images(image_outputs, display_image_num, file_name):
    image_outputs = [torch.clamp(images, -1, 1).expand(-1, 3, -1, -1) for images in image_outputs]  # expand gray-scale img_align_celeba to 3 channels
...
def prepare_sub_folder(output_directory):
    image_directory = os.path.join(output_directory, 'img_align_celeba')
